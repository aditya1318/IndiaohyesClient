...
const ShopPage = () => {
	...
	return (
		<div className='grid min-h-screen overflow-hiddens' style={{ gridTemplateColumns: '3fr 1fr' }}>
			<div className='p-8'>
			...
			<div className='bg-gray-200 border-l-2 border-gray-200 flex flex-col'>
				<div className='flex justify-between items-center p-4 mb-10'>
					...
					<button className='bg-violet rounded-md text-white text-xs px-2 py-1'>Clear</button>
				</div>

				<div className='overflow-auto mb-auto' style={{ height: '20rem' }}>
					{
						cart
